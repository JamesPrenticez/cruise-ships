exports.seed = (knex, Promise) => {
  ...
  return knex('evo').insert([

    // These ships are for Evolution Part 1 page (id: 1 to 6)
    {id: 1,
    ...
    // I believe I have originally missed name_before_lengthening
    name_before_lengthened: '',
    lengthened_para: '', 
    img_lengthened: '', 
    img_lengthened_title: '', 
    name_after_lengthening: '', 
    afterlengthen_para: '',
    // I believe I originally missed img_afterlengthen and img_afterlengthen_title
    img_afterlengthened: '',
    img_afterlengthened_title: '',
    ...
    // Used for Evolution Part 2
    original_ship_name: '',
    original_operator: '1960 to 1966 P & O Orient Lines',
    // Used for Evolution Part 1
    original_name: '',
    early_service_years: '',
    ...
    operator: '1966 to 1973: P & O Line | 1973 to 1986: P & O Cruises',
    registry_port: 'London, England, UK', 
    cost: '12.5 Million British Pounds', 
    imo: '5264742', 
    passenger_capacity_full: 'As Built: 2134 with 688 First Class and 1496 Tourist Class | 1973 onwards: 1750 One Class', 
    crew_capacity: 'As Built 899 or 980 | 1973 onwards: 780', 
    gross_tonnage: '41915', 
    length: '245.1 m (804 feet)', 
    beam: '29.61 m (97 feet)',
    draft: '9.75 m (32 feet)', 
    height: '51.09 m (167 feet inches) or 51.27 m (168 feet 2.5 inches) SS Oriana Website', 
    height_funnel_top: '',
    // Used to be called funnel_height 
    ...
    img_trials: 'Take a photo from ssmaritime.com website/oriana website', 
    img_trials_title: '', 
    early_3rd_para: '', 
    ...
    name_after_lengthening: '', 
    afterlengthen_para: '', 
    // I believe that I originally missed img_afterlengthen and img_afterlengthen_title
    img_afterlengthen: '', 
    ...
    img_trials: "/images/Evolution/France/France leaving Southampton late 1960's", 
    ...
    img_4thcruise: '', 
    img_4thcruise_title: '',
    cruise_5th_para: 'In 2002 she as sold to a Brazil based company called Viagens CVC, was renamed Pacific and operated with Pullmantur Cruises. Pacific did cruises from to   with Pullmunter from 2002 to 2008.', 
    img_5thcruise: '', 
    img_5thcruise_title: '', 
    cruise_6th_para: '', 
    img_6thcruise: '', 
    ...
    // These ships are for Evolution Part 2 page (id: 7 to 12)
    {id: 7,
    ...
    // Height and height to funnel top are the same as when it was Fairstar cruise ship
    ...
    // Cruise Div Section for cruise life of a classic ship (has section id)
    cruise_1st_para: 'The Fairstar began in 1964, but it had a bit of a delayed start due to a financial dispute. What happened was the company Wilton-Fijenoord doing the rebuild in Schiedam Shipyard (Rotterdam) wanted to get paid more for doing extra work. They were in dispute with the new owner Sitmar who purchased her in March 1964, but did not want to accept her because when they had this dispute and they said to the re-builder that all the work was in the original contract.', 
    ...
    cruise_4th_para: 'Here is a photo onboard Fairstar on a 1987 cruise, showing how popular she was as a cruise ship.', 
    ...
    img_5thcruise_title: 'airstar Anchored off Mystery Island, Vanuatu on 24th September, 1988', 
    ...
    operator: 'Cunard Line (1969 to 2008) | Nakheel 2008 to 2018 | PCFC Hotels (2018 to present)',
    ...
    height: '62.1 m (203 feet 8.88 inches) Keel to top of mast', 
    height_funnel_top: '',
    // Used to be called funnel_height 
    speed: 'Maximum 34 knots (63 km/ hr, 39 mph) | Cruising (Service): 28.5 knots (52.8 km/ hr, 32.8 mph)', 
    deadweight: 'I have seen it as 15521 Tonnes (I am trying to find out if it has changed during her career)', 
    lightship: '38099.9 Tonnes', 
    loaded_displacement: '', 
    ...
    draft: '6.7 m (21 feet 11.5 inches)', 
    height: '', 
    height_funnel_top: '',
    // Used to be called funnel_height 
    speed: 'Cruising: 20.5 knots (38 km/hr, 23.6 mph)', 
    deadweight: '3202 Tonnes', 
    lightship: 'I think it was probably in high 12000 Tonnes (Maybe 12960 tonnes', 
    loaded_displacement: 'Maybe 16162 Tonnes', 
    ...
    // I believe I have originally missed name_before_lengthening
    name_before_lengthened: 'Song of Norway', 
    ...
    img_lengthened_title: 'In 1978 Song of Norway stern section was detached so that middle section for lengthening could be floated into place',  
    ...
    img_afterlengthen_title: 'Postcard of Song of Norway after her lengthening anchored off a Caribbean island in 1978',
    ...
    cruise_4th_para: "In 2005 Dream Princess had a change of it's hull colour to black and now operating with Caspi Cruises.", 
    ...
    // This is the Final Div (id = final)
    final_1st_para: '', 
    final_2nd_para: "Sadly this fine cruise ship is no longer with us, but she will be remembered as a valuable ship in terms of increasing Royal Caribbean International's popularity as a cruise line", 
    img_final: '', 
    img_final_title: ''
    },
    ...
    lightship: '13860 Tonnes estimate', 
    loaded_displacement: '17455 Tonnes estimate', 
    ...
    // I believe I originally missed name_before_lengthened
    name_before_lengthened: 'Royal Viking Sky',
    ...
    img_lengthened_title: 'Royal viking Sky lengthened in 1982 at the A.G. Weser shipyard in Bremerhaven, West Germany', 
    ...
    // I believe that I originally missed img_afterlengthen and img_afterlengthen_title
    img_afterlengthened: '/images/Evolution/Royal Viking Sky/RVS_Bordeaux.jpg',
    img_afterlengthened_title: "Royal Viking Sky in Bordeau, France in the early 1980's, still with Royal Viking Line, but with new length of 205.47 m",
    ...
    img_8thcruise: '', 
    img_8thcruise_title: 'As Superstar Capricorn in 2001 in Port',
    ...
    ship_plans_cont: '',
    // This is the Final Div (id = final)
    final_1st_para: 'The covid situation has had an effect on this Boudicca cruise ship. Just before the covid outbreak started in 2020, she was cruising with Fred Olsen Line and in good condition for a ship of her age. When covid happened this fine cruise ship ended her life as an operating cruise ship, initially avoided the scrappers and found a new home in Turkey as an accomodation ship. This meant under covid conditions she was open to the public as a floating hotel.', 
    final_2nd_para: "The covid situatuion caught up in the end and the cost of running her as a floating hotel wasn't sustainable as she wasn't a large cruise ship. In the end the fate came about and she was scrapped in 2021.", 
    img_final: '', 
    img_final_title: ''  
    },    
    ...
    // Used for Evolution Part 2
    original_ship_name: 'Sovereign of the Seas (1988 to 2008)',
    original_operator: 'Royal Caribbean International (1988 to 2008)',
    // Used for Evolution Part 1
    original_name: '',
    early_service_years: '',
    service_years: '1988 to 2008',
    france_service_years: '',
    pacific_princess_years: '',
    pacific_years: '',
    loveboat_final_year: '',
    build_yard: "Chantiers de l'Atlantique, Saint Nazaire, France", 
    operator: 'Pullmantur Cruises (2008 to 2020)',
    ...
    draft: 'Originally 7.55 m (24 feet 9.25 inches) | Later: 7.82 m (25 feet 7.874 inches)', 
    height: '', 
    height_funnel_top: '',
    // Used to be called funnel_height 
    speed: 'Maximum: 21.5 knots (39.8 km/ hr or 24.7 mph)', 
    deadweight: 'Originally: 7,283 Tonnes | Later: 7,546.9 Tonnes', 
    lightship: '34849 Tonnes', 
    loaded_displacement: 'Originally: 42132 Tonnes | Later: 42395.9 Tonnes', 
    power: '21,844 kW (29293.25 Imperial Horsepower)', 
    power_rpm: '',
    fuel_type: '',
    fuel_capacity: '', 
    fuel_consumption: '',
    ...
    // Introduction Photo of ship at top of page on Left hand side  
    img: '/images/Evolution/Allure of the Seas/UFRPU.jpg',
    img_title: 'Allure of the Seas maiden voyage celebration leaving Miami, Florida',
    // Used for Evolution Part 2
    original_ship_name: '',
    ...
    length: '362 m (1,187 feet 8 inches)', 
